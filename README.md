...
## Overview
This repository contains all code, data samples, and documentation needed to train and evaluate the PROPHECG-Age Single model, which predicts a subject’s physiological age from raw single-lead ECG waveforms (200 Hz, 10 s).
